...
<div class="container" role="document">
	<pre style="display:none;">wakanda</pre>
	<?php if (is_single() || is_singular('news-media')) : ?>
		<?php if (!(is_singular('team'))) : ?>
			<?php if (has_post_thumbnail()) : ?>
				<pre style="display:none;">wakanda</pre>
				<?php if (!has_category('success-stories') && !has_category('news')) : ?>
	...
	<?php endif; ?>
	<div class="row <?php echo (is_single()) ? 'page-template-full' : '' ?>">