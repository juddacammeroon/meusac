...
<div class="large-12 columns" id="content" role="main">
	<div class="sub-pages">
		<ul>
			<li class="active"><a href="<?php echo home_url('/noticeboard/tenders'); ?>">Tenders</a></li>
			<li><a href="<?php echo home_url('/noticeboard'); ?>">RFQ'S</a></li>
			<li><a href="<?php echo home_url('/noticeboard/vacancy'); ?>">Vacancy</a></li>
		</ul>
	</div>
	...
	$args = array(
		...
		'post_status'      => 'publish',
		'paged'            => $paged,
		'category_name'         => 'Call for Tenders',
		'orderby' => 'date',
		'order' => 'DESC'
    );
    query_posts($args); ?>
