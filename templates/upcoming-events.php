...
<div class="large-12 columns" id="content" role="main">
	...
	<div class="sub-pages">
		<ul>
			<li class="active"><a href="<?php echo home_url('/events-and-activities'); ?>">Upcoming<span>Events</span></a></li>
			<li><a href="<?php echo home_url('/past-events'); ?>">Past<span>Events</span></a></li>
		</ul>
	</div>
